...
if(temperature >= 80 && rain){
  console.log('its beautiful, get the fuck outside')
} else if(temperature >= 60 && rain) {
  console.log('well its anything over 60 so it could be 100, 200 and the end of the world, no idea but GLHF')
} else if (temperature <= 60 && rain){
  console.log('Wim Hoff that shit')
} else if (temperature >= 80 && !rain) {
  console.log('whities be advised, sunburn imminent')
} else if (temperature >= 60 && !rain) {
  console.log('youre chillin')
} else {
  console.log('now youre literally chillin')
}
